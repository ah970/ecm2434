"""Django settings for hotandcold project.
...
SECRET_KEY = 'django-insecure-al=ag^ipx_@+4#jwt$j&hyh81!ys%xh*k^6-yb&o_)i!ban96r'
...
WSGI_APPLICATION = 'hotandcold.wsgi.application'
...
# Password validation.
# See https://docs.djangoproject.com/en/4.0/ref/settings/#auth-password-validators
